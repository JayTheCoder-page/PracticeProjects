 ...
 * Author: Joshua
 *
 * Created on August 20, 2020, 3:31 PM
 */
...
int main(int argc, char** argv) {
    ...
    Move();//class MyString with Move Constructor and Move Assignment Operator
           //in Addition to Copy Constructor and Copy Assignment Operator
    return 0;
}
void Move()
{
