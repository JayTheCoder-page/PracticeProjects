 ...
 * Author: Joshua
 *
 * Created on August 18, 2020, 3:09 PM
 */
...
int main(int argc, char** argv) {
    ...
    Subscript();//Implementing Subscript Operator [] in class MyString to Allow Random
                //Access to Characters Contained in MyString::buffer
    return 0;
}
void Subscript()
{
